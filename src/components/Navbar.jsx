  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="px-4 md:px-8 py-3 flex items-center justify-between gap-4">
        ...
        <Link
          to="/"
          className="text-netflix-red font-black text-xl md:text-2xl tracking-wider shrink-0 hover:opacity-90 transition-opacity"
        >
          NETFLIX CLONE
        </Link>
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          {/* Profile icon */}
          <div className="hidden md:flex w-8 h-8 rounded bg-netflix-red items-center justify-center text-white text-sm font-bold cursor-pointer hover:brightness-110 transition-all">
            U
          </div>
